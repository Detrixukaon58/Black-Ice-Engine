...
// unsafe fn run_dynamic() -> Result<u32, std::boxed::Box<dyn std::error::Error>> 
// {
//     let mut path = std::env::current_dir().expect("Failed to get executable path!!");
//     let mut path_str = path.to_str().expect("Failed to read executable path!!");
//     #[cfg(target_os = "windows")]
//     let mut lib_path = path_str + "/gamelib/black_ice_lib.dll";
//     #[cfg(target_os = "linux")]
//     let mut lib_path = path_str + "/gamelib/black_ice_lib.so";
//     #[cfg(target_os = "mac")]
//     let mut lib_path = path_str + "/gamelib/black_ice_lib.dynlib";
